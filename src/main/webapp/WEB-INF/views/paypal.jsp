...
<nav class="navbar navbar-default">
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown active"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li class="active"><a href="paypal.html">Create PayPal Account</a></li>
	...
	<div class="container">
		<div class="page-header">
		<h3>
			<strong>Create PayPal Account</strong>
		</h3></div>
		<form action="registerPaypal.html" method="post">
			...
			<div class="form-group">
				<label for="balanceL">Balance</label> <input type="text"
					class="form-control mx-sm-3" id="balance" name="balance"
